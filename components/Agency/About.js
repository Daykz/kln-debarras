                                ...
                                <div className="row">
                                    <div className="col-lg-6 col-md-6">
                                        <div className="single-inner-content">
                                            <div className="title">
                                                ...
                                                <h3 className="okok">Appelez-nous !</h3>
                                            </div>

                                            <p className="okok">Ou envoyez nous un émail, un sms... On fait le point sur ce que vous voulez débarasser, ce que vous voulez en faire et sous quel délai vous en avez besoin ! </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="single-inner-content">
                                            ...
                                            <p className="okok">Suite aux informations que vous nous transmettrez, nous serons en mesure de vous fournir un devis gratuit et sans engagement.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="single-inner-content">
                                            ...
                                            <p className="okok3">Votre satisfaction est primordiale, nous nous engageons à effectuer un travail correspondant à vos attentes dans les plus bref delais</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
