                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="about-content pl-15">
                                ...
                                <br />
                                Que ce soit pour un <b>vide maison</b>, une succession ou un <b>déménagement</b>, un départ en maison de retraite ou seulement vous faire gagner de la place, nous nous occupons du <b>débarras dans son intégralité</b> et dans tout le Centre Val de Loire.
                                <br/><br/>
                                <b>Laissez moi vous expliquer:</b>
                                <br />
                                Vous et votre famille emménager dans une nouvelle maison et vous ne savez pas quoi faire de vos <b>anciens mobiliers</b> ? Le grenier de la maison parentale n'a pas été touché depuis les années 80 et vous êtes bien décidé à le vider une bonne fois pour toute ! Tout cela a l'air bien ennuyant. Il faudrait louer un camion, contacter des amis ou de la famille pour un peu d'aide. C'est là que <b>notre logistique</b> et <b>notre savoir</b> faire interviennent pour faire de cette corvée un mauvais souvenir. </p>
